...
#[cfg(test)]
pub(crate) use self::sidebar::{agent_panel_body_rect, workspace_drop_indicator_row};
...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        expanded_sidebar_toggle_rect, has_orchestration_metadata, normalized_workspace_scroll,
        orchestration_collapse_key, sidebar_section_divider_rect, workspace_drop_slots,
...
fn compute_view_internal(
    ...
    if !app.sidebar_collapsed {
        ...
        let (_, detail_area) =
            expanded_sidebar_sections(sidebar_area, effective_sidebar_section_split(app));
